...
export const extractEntities = (text) =>
  http.post(
    `${urls["solution"] - instance}/entity_extract`,
    { text },
    AUTH_HEADER(),
  );
...
export const runRegression = (X, y) =>
  http.post(
    `${urls["solution"] - instance}/regression`,
    { X, y },
    AUTH_HEADER(),
  );
...
export const runFactorAnalysis = (data, n_factors) =>
  http.post(
    `${urls["solution"] - instance}/factor_analysis`,
    { data, n_factors },
    AUTH_HEADER(),
  );
...
export const runSurvivalAnalysis = (durations, events) =>
  http.post(
    `${urls["solution"] - instance}/survival_analysis`,
    { durations, events },
    AUTH_HEADER(),
  );
