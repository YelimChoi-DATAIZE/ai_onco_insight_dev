...
const TextWithArrow = ({ sentence, word1, word2 }) => {
  ...
  const generatePathD = (positions) => {
    ...
    if (
      positions.topLeft < positions.topRight &&
        ...
        >
          {sentence.split(" ").map((word, index) => (
            <span
              ...
              style={{
                textDecoration:
                  word === word1 || word === word2 ? "underline" : "none",
                textDecorationColor:
                  word === word1 || word === word2 ? "orange" : "inherit",
                textDecorationThickness:
                  word === word1 || word === word2 ? "2px" : "auto",
                fontWeight:
                  word === word1 || word === word2 ? "bold" : "normal",
