...
export const signUp = (formData) =>
  http.post(`${urls["user-auth"]}/signup`, formData);

export const signIn = (formData) =>
  http.post(`${urls["user-auth"]}/signin`, formData);

// auth provider: google
export const googleVerify = (token) =>
  http.post(`${urls["user-auth"]}/google-verify`, { token });
...
export const googleSignIn = (token) =>
  http.post(`${urls["user-auth"]}/google-signin`, { token });
